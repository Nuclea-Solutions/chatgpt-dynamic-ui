...
import { InputWidthAutoCompleteComponent } from './InputWithAutoComplete.component';

import type { Meta, StoryObj } from '@storybook/react';

export default {
	title: 'Main/InputWidthAutoComplete',
	component: InputWidthAutoCompleteComponent,
	tags: ['autodocs'],
	parameters: {
		docs: {
			page: () => (
...
} as Meta<typeof InputWidthAutoCompleteComponent>;

type Story = StoryObj<typeof InputWidthAutoCompleteComponent>;

export const Base: Story = {
	args: {
		labelName: 'Buscar peliculas',
		options: [
