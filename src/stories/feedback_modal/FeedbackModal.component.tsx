...
const FeedbackModalComponent = () => {
	return (
		<div className='relative col-auto col-start-2 row-auto row-start-2 w-full rounded-[8px] text-left shadow-xl transition-all left-1/2 -translate-x-1/2 bg-white dark:bg-gray-900 md:max-w-[672px] lg:max-w-[896px] xl:max-w-6xl'>
				...
				<div className='flex'>
					<div className='flex items-center'>
						...
						<div className='flex flex-col gap-1 text-center sm:text-left'>
							<h2 className='text-2xl font-medium leading-6 text-gray-900 dark:text-gray-200'>
			...
			<div className='p-6'>
				<form>
					<textarea
						...
						rows={3}
						className='mb-1 mt-4 p-3 w-full resize-none rounded-[8px] dark:bg-gray-800 dark:focus:border-white dark:focus:ring-white border-[2px] border-[#8e8ea0] outline-none focus-visible:border-gray-300 text-lg'
						style={{
							overflowY: 'hidden'
						}}
					></textarea>
