...
import MyGPTCardComponent from './MyGPTCard.component';
import {
	Canvas,
	ColorItem,
	ColorPalette,
...
export default {
	title: 'Main/MyGPTCard',
	component: MyGPTCardComponent,
	tags: ['autodocs'],
	parameters: {
		docs: {
			page: () => (
...
} as Meta<typeof MyGPTCardComponent>;

type Story = StoryObj<typeof MyGPTCardComponent>;
